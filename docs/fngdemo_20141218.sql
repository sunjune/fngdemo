...
INSERT INTO `stock_info` VALUES (1,'sh600229','青岛碱业',6.66),(2,'sz000920','南方汇通',14.55),(3,'sh600000','浦发银行',9.9),(4,'sz000547','闽福发Ａ',15.94),(5,'sh600571','信雅达',26.29),(6,'sz000987','广州友谊',13.66),(7,'sh601226','华电重工',15.84),(8,'sh601188','龙江交通',4.46),(9,'sh600396','金山股份',6.63),(10,'sz002735','王子新材',6.22);
...
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='个人单和官方团单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trade_order_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='个人单和官方团单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-12-18 14:07:20
