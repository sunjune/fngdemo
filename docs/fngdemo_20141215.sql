...
CREATE TABLE `stock_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='股票信息';
...
INSERT INTO `stock_info` VALUES (6,'sh600229','青岛碱业',6.66),(5,'sz000920','南方汇通',14.55),(4,'sh600000','浦发银行',9.9),(7,'sz000547','闽福发Ａ',15.94),(8,'sh600571','信雅达',26.29),(9,'sz000987','广州友谊',13.66),(10,'sh601226','华电重工',15.84),(11,'sh601188','龙江交通',4.46),(12,'sh600396','金山股份',6.63),(13,'sz300268','万福生科',6.22);
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='个人单和官方团单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trade_order_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='个人单和官方团单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_info` VALUES (4,'test01','丁一','111111','2014-06-16 22:44:02','tester@user.com','13100131000',NULL,NULL,NULL,NULL,3,'/image/avatar.jpg',0,11.5,0,0,0,1),(5,'test02','刘二','111111','2014-06-17 22:58:15','tester@user.com','13100131000',NULL,NULL,NULL,NULL,0,'/image/avatar.jpg',0,11.5,0,0,0,0),(6,'test03','李三','111111','2014-06-17 22:59:30','tester@user.com','13100131000',NULL,NULL,NULL,NULL,0,'/image/avatar.jpg',0,11.5,0,0,0,0),(7,'test04','赵四','111111','2014-06-28 20:49:17','tester@user.com','13100131000',NULL,NULL,NULL,NULL,0,'/image/avatar.jpg',0,11.5,0,0,0,0),(8,'test05','王五','111111','2014-06-28 20:54:18','tester@user.com','13100131000',NULL,NULL,NULL,NULL,0,'/image/avatar.jpg',0,11.5,0,0,0,0),(9,'test06','梅六','111111','2014-06-28 22:29:03','tester@user.com','13100131000',NULL,NULL,NULL,NULL,1,'/image/avatar.jpg',0,11.5,0,0,0,0),(10,'test07','吴七','111111','2014-06-28 22:51:36','tester@user.com','13100131000',NULL,NULL,NULL,NULL,0,'/image/avatar.jpg',0,11.5,0,0,0,0),(11,'test08','宁八','111111','2014-06-28 23:33:27','tester@user.com','13100131000',NULL,NULL,NULL,NULL,2,'/image/avatar.jpg',0,11.5,0,0,0,0);
...
-- Dump completed on 2014-12-15 14:14:21
